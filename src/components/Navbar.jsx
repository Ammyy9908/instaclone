        ...
        <div className="navbar">
            <div className="nav__container">
                <div className="nav__brand">
                    <Link to="/"><img src={brand} alt="insta_logo"/></Link>
                </div>
